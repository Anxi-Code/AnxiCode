        ...
        Scaffold(
          ...
          appBar: AppBar(
            iconTheme: IconThemeData(
              ...
              backgroundColor: Colors.transparent,
            title: Text("AnxiCode",style: GoogleFonts.orbitron(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold),),
            centerTitle: true,
          ),
          drawer: Drawer(
            ...
            child: ListView(
              children: [
                UserAccountsDrawerHeader(
                  ...
                  accountName: Text("Meesum Afzaal",style: GoogleFonts.orbitron(color: Colors.white,fontWeight: FontWeight.bold),),
                  accountEmail: Text("abcd@example.com",style: TextStyle(color: Colors.grey.shade400,fontStyle: FontStyle.italic),),
                ...
                GestureDetector(
                  ...
                  child: ListTile(
                    ...
                    title: Text("Log out",style: GoogleFonts.orbitron(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 14),),
